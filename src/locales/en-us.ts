  ...
  pages: {
    ...
    system: {
      ...
      menu: {
        ...
        linkMethodTooltip: 'When iframe is opened and route file is set at the same time, route file takes priority',
        supportCache: 'Support Cache',
        requiredWhenNoLink: 'Required when no link is set',
        addMenu: 'Add Menu',
        editMenu: 'Edit Menu',
      },
