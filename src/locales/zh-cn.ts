export default {
  pages: {
    ...
    system: {
      menu: {
        ...
        linkAddress: '外链地址',
        linkMethod: '外链方式',
        linkMethodTooltip: 'iframe 打开时若同时设置了路由文件，则优先使用路由文件',
        supportCache: '支持缓存',
        requiredWhenNoLink: '未设置外链时该项必填',
        addMenu: '新增菜单',
        editMenu: '编辑菜单',
      },
      user: {
  ...
  routes: {
    ...
    noLayout: '无布局',
    menuManagementExternal: '菜单管理(外部打开)',
    baiduIframe: '百度(iframe 打开)',
    menuManagementIframe: '菜单管理(iframe 打开)',
